            ...
            <div className="w-3/4 p-8">
              ...
              <div className="grid grid-cols-12 gap-4">
                <Link to={ROUTE_PATH.DASHBOARD} className="col-span-6">
                  <button className="w-full bg-blue-500 text-white">Facebook</button>
                </Link>
                <Link to={ROUTE_PATH.DASHBOARD} className="col-span-6">
                  <button className="w-full bg-red-500 text-white">Google</button>
                </Link>
              </div>
              <br/>
              <hr />
              ...
              <p className="text-center">
                Don't have an account? <Link to={ROUTE_PATH.REGISTER}><span>Sign up</span></Link>
              </p>
            </div>
            <div className="w-1/2">
